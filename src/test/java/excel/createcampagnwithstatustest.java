...
public class createcampagnwithstatustest {
	...
	public static void main(String[] args) throws InterruptedException, IOException {
		...
		// Now load the data into prop.
			   ...
			   String Campaignname = wb.getSheet("Sheet1").getRow(4).getCell(2).getStringCellValue();
			 String status = wb.getSheet("Sheet1").getRow(4).getCell(3).getStringCellValue();
			   String target_size = wb.getSheet("Sheet1").getRow(4).getCell(4).getStringCellValue();
			wb.close();
